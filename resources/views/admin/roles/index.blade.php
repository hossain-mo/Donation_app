        ...
        <div class="m-portlet__head-tools">
            ...
            @can('create_roles')
                <li class="m-portlet__nav-item">
                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air" data-toggle="modal" data-target="#create_role_modal">
                                    <span>
...
@can('create_roles')
<!--begin::Modal-->
<div class="modal fade" id="create_role_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Create Role</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:create_role();">
                    <div class="m-portlet__body">
                        <div class="row">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="create_role" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="update_role_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Update Role</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:update_role();">
                    <div class="row">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="edit_role" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
@can('delete_roles')
<!--begin::Modal-->
<div class="modal fade" id="delete_role_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title delete" id="model-title">Delete Role</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
            </div>
            <div class="modal-body">
                ...
                <h4 id="delete"> Do You Sure You Want To Delete This Role</h4>
            </div>
            <form class="m-form m-form--fit m-form--label-align-right">
                <div class="m-portlet__foot m-portlet__foot--fit">

                    <div class="m-form__actions">
                        <button type="button" id="role_button_delete" class="btn btn-primary">DELETE</button>
                    </div>
                </div>
            </form>
            <div class="modal-footer">
                    ...
                    "columns": [
                        {
                            ...
                            return "<a  data-toggle='modal' onClick='edit_modal(" + JSON.stringify(row) + ")' data-target='#update_role_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='la la-edit'></i></a>" +
                             "<a  data-toggle='modal' onClick='delete_modal(" + JSON.stringify(row) + ")' data-target='#delete_role_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='flaticon-delete-1'></i></a>";                            }
                        },
                        {
                        data: "id",
                        title: "#",
...
$(document).ready(function () {
    ...
    $("#permissions").select2({closeOnSelect: false});
    $("#edit_permissions").select2({closeOnSelect: false});
});
...
function update_role(){
    ...
    $.ajax({
                type: "PUT",
                url: "{{URL::to('/admin/roles/')}}" +"/" + $("#update_id").val(),
                data: {
                    name     : $("#edit_name").val(),
...
function create_role(){
    $.ajax({
                ...
                error : function(data){
                    $.notify({
	                // options
	                message: "rolename already taken"
                    },{
	                // settings
	                type: "warning"
                    });
...
function delete_role(){
    var roleId = $("#delete_id").val();
    $.ajax({
                type: "DELETE",
                url: "{{URL::to('/admin/roles/')}}" +"/" + roleId,
                data: {
                },
                dataType: "JSON",
                success: function (data) {
