    ...
    <div class="m-portlet__head">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                @can('create_project_categories')
                <li class="m-portlet__nav-item">
                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air" data-toggle="modal" data-target="#create_project_category_modal">
                                    <span>
...
@can('create_project_categories')
<!--begin::Modal-->
<div class="modal fade" id="create_project_category_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Create Project Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:create_project_category();">
                    <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="create_project_category" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
<!--end::Modal-->
@endcan
@can('update_project_categories')
<!--begin::Modal-->
<div class="modal fade" id="update_project_category_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Update Project Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:update_project_category();">
                        <div class="form-group m-form__group">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="edit_project_category" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
@endcan
@can('delete_project_categories')
<!--begin::Modal-->
<div class="modal fade" id="delete_project_category_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title delete" id="model-title">Delete Project Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
            </div>
            <div class="modal-body">
                ...
                <h4 id="delete"> Do You Sure You Want To Delete This Project Category</h4>
            </div>
            <form class="m-form m-form--fit m-form--label-align-right">
                <div class="m-portlet__foot m-portlet__foot--fit">

                    <div class="m-form__actions">
                        <button type="button" id="project_category_button_delete" class="btn btn-primary">DELETE</button>
                    </div>
                </div>
            </form>
            <div class="modal-footer">
...
var datatableInit = function () {
        ...
        return {
            init: function () {
                ...
                t = $("#m_datatable").DataTable({
                    ...
                    processing: !0,
                    ajax: {
                        url: "{{route('project-category-list')}}",
                        type: "GET",
                        data: function (d) {
                            d.date      = $("#date").val()
                        },
                    ...
                    "columns": [
                        {
                            ...
                            return "<a  data-toggle='modal' onClick='edit_modal(" + JSON.stringify(row) + ")' data-target='#update_project_category_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='la la-edit'></i></a>" +
                             "<a  data-toggle='modal' onClick='delete_modal(" + JSON.stringify(row) + ")' data-target='#delete_project_category_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='flaticon-delete-1'></i></a>";                            }
                        },
                        {
                        data: "id",
                        title: "#",
    ...
    $(document).ready(function () {
        @can('read_project_categories')
        datatable = datatableInit.init();
        @endcan
        $('#project_category_button_delete').click(function(){
...
function edit_modal(row){
    ...
    $("#edit_country_id").val(row["country_id"]).change();
}
function delete_modal(row){
    $("#delete_id").val(row["id"]);
}
@can('update_project_categories')
function update_project_category(){
    
    $.ajax({
                type: "PUT",
                url: "{{URL::to('/admin/project-categories/')}}" +"/" + $("#update_id").val(),
                data: {
                    name       : $("#edit_name").val(),
                },
                dataType: "JSON",
                success: function (data) {
                    $.notify({
	                // options
	                message: "update project_category successfully"
                    },{
	                // settings
	                type: "success"
                    });
                    $("#update_project_category_modal .close").click()
...
function create_project_category(){
    $.ajax({
                type: "POST",
                url: "{{route('add-project-category')}}",
                data: {
                    name       : $("#name").val(),
                },
                dataType: "JSON",
                success: function (data) {
                    ...
                    $("#create_project_category_modal .close").click()
                    datatable.ajax.reload()
...
function delete_project_category(){
    var projectCategoryId = $("#delete_id").val();
    $.ajax({
                type: "DELETE",
                url: "{{URL::to('/admin/project-categories/')}}" +"/" + projectCategoryId,
                data: {
                },
                dataType: "JSON",
                success: function (data) {
                    ...
                    $("#delete_project_category_modal .close").click()
                    datatable.ajax.reload()
