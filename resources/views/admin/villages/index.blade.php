        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                ...
                <li class="m-portlet__nav-item">
                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air" data-toggle="modal" data-target="#create_village_modal">
                                    <span>
...
@can('create_villages')
<!--begin::Modal-->
<div class="modal fade" id="create_village_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Create Village</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:create_village();">
                    <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <select id=country_id class="form-control select2picker" value="" 
                                    style="width:100%;">
                                    <option value=""></option>
                                    @if(count($countries))
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="create_village" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
@can('update_villages')
<!--begin::Modal-->
<div class="modal fade" id="update_village_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="model-title">Update Village</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="add" action="javascript:update_village();">
                        <div class="form-group m-form__group">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <select id="edit_country_id" class="form-control select2picker" value=""
                                 style="width:100%;">
                                <option value=""></option>
                                @if(count($countries))
                                @foreach($countries as $country)
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <button type="submit" id="edit_village" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
@can('delete_villages')
<!--begin::Modal-->
<div class="modal fade" id="delete_village_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title delete" id="model-title">Delete Village</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
            </div>
            <div class="modal-body">
                ...
                <h4 id="delete"> Do You Sure You Want To Delete This Village</h4>
            </div>
            <form class="m-form m-form--fit m-form--label-align-right">
                <div class="m-portlet__foot m-portlet__foot--fit">

                    <div class="m-form__actions">
                        <button type="button" id="village_button_delete" class="btn btn-primary">DELETE</button>
                    </div>
                </div>
            </form>
            <div class="modal-footer">
...
var datatableInit = function () {
                    ...
                    "columns": [
                        {
                            ...
                            return "<a  data-toggle='modal' onClick='edit_modal(" + JSON.stringify(row) + ")' data-target='#update_village_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='la la-edit'></i></a>" +
                             "<a  data-toggle='modal' onClick='delete_modal(" + JSON.stringify(row) + ")' data-target='#delete_village_modal'  id='test_click' class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill'><i class='flaticon-delete-1'></i></a>";                            }
                        },
                        {
                        data: "id",
                        title: "#",
    ...
    $(document).ready(function () {
        ...
        @endcan
        $('#village_button_delete').click(function(){
                delete_village();
        });
});
...
function update_village(){
    ...
    $.ajax({
                type: "PUT",
                url: "{{URL::to('/admin/villages/')}}" +"/" + $("#update_id").val(),
                data: {
                    name       : $("#edit_name").val(),
                ...
                success: function (data) {
                    ...
                    $("#update_village_modal .close").click()
...
function create_village(){
    $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#create_village_modal .close").click()
                    datatable.ajax.reload()
...
function delete_village(){
    var villageId = $("#delete_id").val();
    $.ajax({
                type: "DELETE",
                url: "{{URL::to('/admin/villages/')}}" +"/" + villageId,
                data: {
                },
                dataType: "JSON",
                success: function (data) {
                    ...
                    $("#delete_village_modal .close").click()
                    datatable.ajax.reload()
