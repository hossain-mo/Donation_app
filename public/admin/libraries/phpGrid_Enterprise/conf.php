...
$dotenv->load();
//* mysql example 
defined('PHPGRID_DB_HOSTNAME')? : define('PHPGRID_DB_HOSTNAME', 'localhost'); // database host name
defined('PHPGRID_DB_USERNAME')? : define('PHPGRID_DB_USERNAME', env('DB_USERNAME', ''));     // database user name
defined('PHPGRID_DB_PASSWORD')? : define('PHPGRID_DB_PASSWORD', env('DB_PASSWORD', '')); // database password
defined('PHPGRID_DB_NAME')? : define('PHPGRID_DB_NAME', env('DB_DATABASE', '')); // database name
defined('PHPGRID_DB_TYPE')? : define('PHPGRID_DB_TYPE', 'mysql');  // database type
defined('PHPGRID_DB_CHARSET')? : define('PHPGRID_DB_CHARSET','utf8'); // ex: utf8(for mysql),AL32UTF8 (for oracle), leave blank to use the default charset
/**/
...
defined('SERVER_ROOT')? :define('SERVER_ROOT', '/admin/libraries/phpGrid_Enterprise');
defined('THEME')? :define('THEME', 'smoothness');
defined('FRAMEWORK')? :define('FRAMEWORK', '');	// indicating framework integrating - not used yet
defined('DEBUG')? :define('DEBUG', false); // *** MUST SET TO FALSE WHEN DEPLOYED IN PRODUCTION ***
defined('CDN')? :define('CDN', false);        // use Cloud CDN by default. False to use the local libraries
defined('UPLOADEXT')? :define('UPLOADEXT', 'gif,png,jpg,jpeg');
